...
### tests
  We make in free form javascript tests with fetch requests. You have example/template of requests to backend. If you want to start it, do command: `npm install` inside folder. Start `test` in `__test__`:
